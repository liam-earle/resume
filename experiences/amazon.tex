\vspace{0.1cm}
\textbf{Amazon \hfill Aug 2024 -- Dec 2024, May 2025 -- present} \par
\textit{Software Development Engineer - Amazon Robotics} \par
\begin{itemize}
    \item Lead front-end development of new application allowing users to generate custom reports on robotic warehouse shelves.
